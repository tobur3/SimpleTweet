...
import static com.codepath.apps.restclienttemplate.R.*;
...
public class TimelineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer = findViewById(id.swipeContainer);
        ...
        rvTweets = findViewById(id.rvTweets);
